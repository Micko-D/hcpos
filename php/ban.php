...
if (isMobileDevice()) {
    ...
    $currentTime = date("H:i:s");
        ...
        $cusStatus = $_POST['customerStatus'];
        ...
        VALUES ('$role', '$userid', '$currentDate', '$currentTime', '$device', 'Unban Profile', '$cusID', 'User')";
        }else{
        $sql = "UPDATE users 
        SET verified = 'Ban'
        WHERE userid = '$cusID'";
        ...
        $auditSql = "INSERT INTO `audit` (`role`, userid, `date`, `time`, fromdev, `action`, prodname, info)
        VALUES ('$role', '$userid', '$currentDate', '$currentTime', '$device', 'Ban Profile ', '$cusID', 'User')";
        }
